...
export const useAddPrayer = () => {
  return useFirestoreAddDoc<Prayer>('prayer_requests', [
    queryKeys.prayers.list() as unknown as unknown[],
    queryKeys.prayers.all as unknown as unknown[],
  ]);
};

// 기도 삭제
export const useDeletePrayer = () => {
  return useFirestoreDeleteDoc('prayer_requests', [
    queryKeys.prayers.list() as unknown as unknown[],
    queryKeys.prayers.all as unknown as unknown[],
  ]);
};

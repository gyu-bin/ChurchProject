...
import {
    View, Text, StyleSheet, SafeAreaView, RefreshControl, FlatList,
...
const styles = StyleSheet.create({
    ...
    notice: { fontSize: 14, marginBottom: 4 },
    card: { backgroundColor: '#fff', borderRadius: 10, padding: 16, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, elevation: 3, marginBottom: 12 },
    thumbnail: { width: '100%', height: 250, borderRadius: 8, marginBottom: 10 },
    link: { color: '#3b82f6', fontWeight: 'bold' },
    prayerButton: { backgroundColor: '#10b981', padding: 12, borderRadius: 8, marginTop: 12, alignItems: 'center' },
